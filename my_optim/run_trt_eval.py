...
Usage:
    python run_trt_eval.py --precision fp16
    python run_trt_eval.py --precision int8
"""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "INT8 engine variant suffix (e.g. 'pct99p9', 'mse'). "
            "Maps to engines/<model>/int8_<variant>.engine. "
